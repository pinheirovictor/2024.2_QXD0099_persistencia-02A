...
for nome_arquivo in os.listdir(diretorio):
    ...
    if nome_arquivo.endswith(".txt") and os.path.isfile(caminho_arquivo):
        print(f"Processando {nome_arquivo}...")  # Log para verificar os arquivos processados
...
print(f"Arquivo consolidado '{consolidado}' criado com sucesso.")

# Etapa 3: Compactar em um arquivo ZIP
with ZipFile(zip_final, "w") as zip_arquivo:
    zip_arquivo.write(consolidado)
print(f"Arquivo ZIP '{zip_final}' criado com sucesso.")
